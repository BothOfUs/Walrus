...
function createCalendar()
{
    ...
    if (isset($_GET['end'])) {
        ...
        if ($end_year = substr($todays_date, 0, 4)) {
            if ($end_month > substr($todays_date, 5, 2)) {
                $end_month = substr($todays_date, 5, 2);
            }
        }
    }
...
function mk_drawCalendar($m, $y)
{
    ...
    <table cellpadding=2 cellspacing=1 border=0 bgcolor="<?php echo $calendar_outline; ?>">
        ...
        <tr bgcolor="<?php echo $calendar_outline; ?>">
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">S</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">M</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">T</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">W</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">TH</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">F</font></th>
            <th width=22 bgcolor="<?php echo $calendar_bgcolor; ?>" class="tcell"><font
                        face="Verdana, Arial, Helvetica, sans-serif" size="2"
                        color="<?php echo $calendar_font_color; ?>">SA</font></th>
        </tr>
        ...
        while ($d <= $lastday) {
            ...
            if ((file_exists($filetofind)) || (file_exists($filetofind2))) {
                if ($fulldate <= date("Y-m-d")) {
                    ...
                    print "<td class='tcell' bgcolor=\"" . $calendar_bgcolor . "\" align=\"center\">";
